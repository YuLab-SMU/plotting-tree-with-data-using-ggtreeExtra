...
(ref:ggdist) This example to show ggtreeExtra works with *geom_dots* and *geom_slabinterval* of *ggdist*[@ggdist].
...
```{r, fig.width=8, fig.height=5, error=TRUE, warning=FALSE, message=FALSE, fig.cap='(ref:ggpattern)', dev="CairoPNG", dpi=300, GeomLayers2}
library(ggtree)
library(ggtreeExtra)
library(ggpattern)
library(ggplot2)
