...
x <- "ggdist\tgeom_dotsinterval\talpha, color, fill, size, shape\tcreates dots, intervals, and quantile dotplots\n
...
ggpattern\tgeom_bar_pattern\tpattern_alpha, pattern_color, pattern_fill, pattern_angle, alpha, color, fill\tdraws bar charts with support for pattern fills\n
...
ggpattern\tgeom_col_pattern\tpattern_alpha, pattern_color, pattern_fill, pattern_angle, alpha, color, fill\tdraws bar charts using ’stat_identity()’ with support for pattern fills\n
ggpattern\tgeom_tile_pattern\tpattern_alpha, pattern_color, pattern_fill, pattern_angle, alpha, color, fill\tdraws rectangle by using the center of the tile and its size with support for pattern fills\n
...
ggrepel\tgeom_label_repel\talpha, color, fill, size\tdraws a rectangle underneath the text. The text labels repel away from each other and away from the data ponts\n
...
y <- as.data.frame(y)
colnames(y) <- c("Package", "Geom Layer", "Attributes", "Description")
