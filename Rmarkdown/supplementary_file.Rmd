...
```{r, echo=FALSE, message=FALSE, warning=FALSE,  fig.width=6.8, fig.height=3.5, error=FALSE, fig.cap='(ref:comparison)', dev="CairoPNG", dpi=300, results='asis', out.width = '50%', compare}
require(kableExtra)
...
ETE3\tPython,package\trectangular\tHeat map,scatter,simple bar,stacked bar,box,pie,image plot,protein domain,MSA[note]\tYes\tadd\tNo\tprogramming,and command,line\n
iTOL\tWeb,tool\tcircular,rectangular,slanted,ellipse,inward circular\tHeat map,scatter,simple bar,stacked bar,dodged bar,box,line plot,pie,image plot,protein domain,MSA\tYes\tadd\tNo\tinteractive,(mouse click,with,configure file)\n
...
Evolview\tWeb,tool\tcircular,rectangular,slanted,round rectangular\tHeat map,scatter,simple bar,stacked bar,protein domain\tYes\tadd\tNo\tinteractive,(mouse click with,configure file)\n"
