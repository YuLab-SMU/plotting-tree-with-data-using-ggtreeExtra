...
install.packages(c("ggplot2", "patchwork", "ggridges"))

# For Fig.S4, you also need to install 'ggpattern'.
# because ggpattern have not been released on CRAN.
...
# or if Bioconductor 1.13 is released, you can use `BiocManager::install("treeio")` to install it.
