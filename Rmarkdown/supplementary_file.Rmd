...
ggdist\tgeom_dots\talpha, color, fill, size, shape\tcreates dotplots that automatically determines a bin\n
ggdist\t \t \twidth that ensures the plot fits within the available space\n
...
ggpmisc\tgeom_plot\tvp.width,vp.height\tggplot objects as insets to the base ggplot,\n
ggpmisc\t \t \tusing syntax similar to that of 'geom_label'\n
ggpmisc\tgeom_table\tsize\tadds a textual table directly to the ggplot,\n
ggpmisc\t \t \tusing syntax similar to that of 'geom_label'\n
ggpmisc\tgeom_grob\tvp.width,vp.height\tadd a Grob as inset to the ggplot,\n
ggpmisc\t \t \tusing syntax similar to that of 'geom_label'\n
...
p1 <- ggtree(tr,
      ...
      geom_tiplab(align=T, size=1.2) 

p2 <- p1 +
      geom_fruit(
                 data=dt,
                 geom=geom_plot,
                 mapping=aes(y=id, label=plot),
                 offset=0.4,
                 position=position_identityx(),
                 vjust=0.6,
                 hjust=0.6,
