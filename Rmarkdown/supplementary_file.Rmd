...
The *ggtreeExtra* package enable us to link *ggtree* [@ggtred1] and geometric layers defined in the *ggplot2* community (Tab. \ref{tab:geom} and Fig. \ref{fig:OverView}). Different annotation layers to visualize high-dimensional associated data sets can be combined freely to create complex tree graphic. As demonstrated in Fig \@ref{fig:HMP}, visualizing a data graphic layer is simple and multiple layers can be added progressively in *ggtreeExtra*. 
