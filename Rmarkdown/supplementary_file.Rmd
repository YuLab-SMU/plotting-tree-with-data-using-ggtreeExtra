...
We also provided a docker image^[<https://hub.docker.com/r/xushuangbin/ggtreeextraarticleenv>] to help users to build the computing environment. Users can pull and run it according to the following. They don't need to install the dependency packages.
