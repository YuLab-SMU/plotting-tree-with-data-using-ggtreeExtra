...
Displaying photo of representative species on a phylogenetic tree is commonly used to compare morphological differences. ETE3 [@ETE3] and iTOL [@iTOL] support linking external images to any tree node. The *ggtreeExtra* is more powerful and flexible. In addition to link external images, it supports querying silhouette images directly from the PhyloPic database^[<http://phylopic.org/>] and it allows aesthetic mapping to fill the color and rescale the size of the images using tree associated data variable. Moreover, 


Supporting adding taxon-specific graphical information on the outside of phylogenetic tree is one of the important features of *ggtreeExtra*. Although , and also support this, *ggtreeExtra* is more powerful and flexible. 
