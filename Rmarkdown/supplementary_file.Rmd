...
In this session, we emphasize another part of the grammar of graphics -- the ggplot2 layered graphics. 

Here, we reproduce Fig.2 of [@morgan2013HMP] to show how to display multiple associated data to circular phylogenetic tree using *ggtreeExtra* again. The data sets are provided by GraPhlAn [@GraPhlAn], but they were mixed with the profiler of graphic for GraPhlAn [@GraPhlAn]. 
