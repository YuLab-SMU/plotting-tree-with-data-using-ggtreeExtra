...
## Dependencies and locations
  ...
  + R ( >= 4.0.3 ) should be installed and located in the user's PATH, and the following packages also should be installed.
    - `ggtreeExtra`
    - `ggtree`
    - `treeio`
    - `tidytree`
...
Here is the output of `sessionInfo()` on the system on which [the document](https://github.com/YuLab-SMU/plotting-tree-with-data-using-ggtreeExtra/blob/master/Rmarkdown/supplementary_file.pdf) was compiled:
