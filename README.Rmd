...
## Dependencies and locations
  ...
  + R ( >= 4.0.3 ) should be installed and located in the user's PATH
    + the following packages also should be installed.
      ...
      'bookdown', 'ggstar', 'tidyverse', 'Cairo', 'openxlsx', 'patchwork', 'ggnewscale', 'knitr'.```
...
To compile the <!-- Rmarkdown/manuscript.docx and --> Rmarkdown/supplemental_file1.pdf, please run the following command on terminal of Linux or Mac.
